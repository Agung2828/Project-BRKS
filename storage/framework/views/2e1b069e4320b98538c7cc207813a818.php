...
<html lang="en">
    <head>
        ...
        <link href="<?php echo e(asset('halaman_depan/css/styles.css')); ?>" rel="stylesheet" />
    </head>
    <body id="page-top">
        <!-- Navigation-->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" 
                                href="<?php echo e(route('auth')); ?>">Login</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        <style>
          ...
          <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">   
              ...
              <img class="masthead-avatar mb-5" src="<?php echo e(asset('halaman_depan/assets/img/portfolio/logovbrk.png')); ?>" alt="Avatar" />
              <!-- Masthead Heading-->
...
SWIFT Code: PDRIIDJA
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <img class="img-fluid rounded mb-5" src="<?php echo e(asset('halaman_depan/assets/img/portfolio/Produk_Giro_Valas_BRK_Syariah.png')); ?>" alt="..." />
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="<?php echo e(asset('halaman_depan/assets/img/portfolio/Produk_Giro_Valas_BRK_Syariah.png')); ?>" alt="Giro Valas" />
                                    <!-- Portfolio Modal - Text-->
                                    <p class="mb-4">
                                        Simpanan Dana Pihak Ketiga untuk nasabah non-perorangan dalam mata uang asing yang penarikannya hanya dapat dilakukan dengan persyaratan tertentu yang disepakati atau instruksi khusus (menggunakan akad mudharabah).
                                    </p>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="<?php echo e(asset('halaman_depan/assets/img/portfolio/DHUHA_FLEXI.png')); ?>" alt="Dhuha flexi" />
                                    <!-- Portfolio Modal - Text-->
                                    <p class="mb-4">
    ...
    <div class="modal-dialog modal-xl">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            ...
                            <!-- Portfolio Modal - Image-->
                            <img class="img-fluid rounded mb-5" src="<?php echo e(asset('halaman_depan/assets/img/portfolio/SINAR_DELIMA1.png')); ?>" alt="Dhuha flexi" />
                            <!-- Portfolio Modal - Text-->
                            <p class="mb-4">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <div class="divider-custom">
                                      ...
                                      <!-- Portfolio Modal - Image-->
                            <img class="img-fluid rounded mb-5" src="<?php echo e(asset('halaman_depan/assets/img/portfolio/Sinar_DBOS.png')); ?>" alt="Dhuha flexi" />
                                    <!-- Portfolio Modal - Text-->
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <div class="divider-custom">
                                     ...
                                     <!-- Portfolio Modal - Image-->
                            <img class="img-fluid rounded mb-5" src="<?php echo e(asset('halaman_depan/assets/img/portfolio/Simpel_gambar1.png')); ?>" alt="Dhuha flexi" />
                                    <!-- Portfolio Modal - Text-->
                                    <p class="mb-4">
        ...
        <!-- Core theme JS-->
        <script src="<?php echo e(asset('halaman_depan/js/scripts.js')); ?>"></script>
        <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
        <!-- * *                               SB Forms JS                               * *-->
...
<?php /**PATH C:\xampp\htdocs\laravel10\project-laravel10\resources\views/halaman_depan/index.blade.php ENDPATH**/ ?>