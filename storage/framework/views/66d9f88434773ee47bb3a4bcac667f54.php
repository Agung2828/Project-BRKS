...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="<?php echo e(asset('halaman_auth/images/icons/favicon.ico')); ?>"/>
<!--===============================================================================================-->
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<div class="login100-more" style="background-image: url('<?php echo e(asset('halaman_auth/images/bg-01.jpg')); ?>');">
				</div>
			</div>
		</div>
	</div>
...
</html><?php /**PATH C:\xampp\htdocs\laravel10\project-laravel10\resources\views/halaman_depan/halaman_auth/login.blade.php ENDPATH**/ ?>