...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset('halaman_auth/fonts/font-awesome-4.7.0/css/font-awesome.min.css')); ?>">
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset('halaman_auth/fonts/Linearicons-Free-v1.0.0/icon-font.min.css')); ?>">
    <!--===============================================================================================-->
    ...
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset('halaman_auth/vendor/daterangepicker/daterangepicker.css')); ?>">
    <!--===============================================================================================-->
    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                <form action="<?php echo e(route('auth')); ?>" class="login100-form validate-form" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz"
                        ...
                        <span class="label-input100" autocomplete="off">Email</span>
                    </div>
                    ...
                    <div class="text-center p-t-46 p-b-20">
                        <span class="txt2">
                            <a href="<?php echo e(route('registrasi')); ?>" class="text-primary">register</a> or sign up using
                        </span>
                    </div>
                </form>
                ...
                <div class="login100-more">
                    <div class="slideshow-container">
                        <div class="mySlides">
                            <img src="<?php echo e(asset('halaman_auth/images/brk_syariah.jpg')); ?>"height="900"
                                style="width:100%;">
                        </div>

                        <div class="mySlides">
                            <img src="<?php echo e(asset('halaman_auth/images/brksenja.jpg')); ?>" height="900"
                                style="width:100%;">
                        </div>
                        <div class="mySlides">
...
<?php /**PATH C:\xampp\htdocs\laravel10\project-laravel10\resources\views/halaman_auth/login.blade.php ENDPATH**/ ?>