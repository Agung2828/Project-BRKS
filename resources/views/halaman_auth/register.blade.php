	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="{{ route('registrasi.store') }}" class="login100-form validate-form" method="POST" enctype="multipart/form-data">
                    @csrf
...
@endif
				...
				<div class="login100-more">
					<div class="slideshow-container">
						<div class="mySlides">
							<img src="{{ asset('halaman_auth/images/brk_syariah.jpg') }}"height="900" style="width:100%;">
						</div>
				
						<div class="mySlides">
							<img src="{{ asset('halaman_auth/images/brksenja.jpg') }}" height="900" style="width:100%;">
						</div>
						<div class="mySlides">
